(() => {
    ...
    function initHome() {
        ...
        grid.querySelector('[data-istikhara]')?.addEventListener('click', openIstikhara);
    }
    ...
    function openIstikhara() {
        ...
        q('mafatihHeaderTitle').textContent = 'الاستخارة بالقرآن الكريم';
