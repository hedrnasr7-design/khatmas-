const firebaseConfig = {
        ...
        async function syncDataFromNetwork() {
            ...
            try {
                ...
                // لا نحفظ البيانات محليًا إلا بعد وصولها بنجاح من Firebase.
                updateProgressUI(96);
        ...
        async function initializeOfflineFirstApp() {
            ...
            // الأولوية للشبكة: جلب Firebase قبل قراءة التخزين المحلي.
            const networkSucceeded = await syncDataFromNetwork();

            // التخزين المحلي هو حل احتياطي عند انقطاع الشبكة أو فشل Firebase.
            if (!networkSucceeded) {
