...
function applyUserSettings(settings = {}, persist = false) {
    const s = { ...defaultUserSettings, ...(settings || {}) }, root = document.documentElement;
    const vars = { pageBg:'--user-page-bg', cardBg:'--user-card-bg', primary:'--user-primary', accent:'--user-accent', text:'--user-text', border:'--user-border', allBg:'--user-all-bg', imagesBg:'--user-images-bg', favBg:'--user-fav-bg', modalBg:'--user-modal-bg', modalText:'--user-modal-text' };
