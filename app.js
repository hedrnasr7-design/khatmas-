        ...
        window.submitAdminLogin = async () => {
            ...
            try {
                ...
                if (!user.emailVerified) {
                    ...
                    if (status) status.innerText = 'أرسلنا رسالة تحقق إلى بريد المشرف. تحقق من البريد ثم حاول مجددًا.';
                    return;
                }
                const loginBox = document.getElementById('adminLoginBox');
                ...
                if (status) status.innerText = 'تعذر تسجيل الدخول. تحقق من كلمة المرور وإعدادات Firebase.';
            }
        };
