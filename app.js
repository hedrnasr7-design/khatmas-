...
function startAppAfterAccess() {
    ...
    if (accessMode !== 'admin' && typeof window.setAppPage === 'function') window.setAppPage(Number(localStorage.getItem('khatmas_last_app_page_v3') || localStorage.getItem('khatmas_last_app_page_v2') || localStorage.getItem('khatmas_last_app_page') || 1));
...
window.addEventListener('load', () => {
    ...
    setTimeout(() => {
        if (typeof window.setAppPage === 'function' && !document.body.dataset.appPage) window.setAppPage(Number(localStorage.getItem('khatmas_last_app_page_v3') || localStorage.getItem('khatmas_last_app_page_v2') || localStorage.getItem('khatmas_last_app_page') || 1));
