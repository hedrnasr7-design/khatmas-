...
function renderHomePrayerTimes() {
    ...
    if (status) status.textContent = 'المواقيت المحسوبة لمدينة بغداد';
}
async function loadMafatihTodaySettings() {
    ...
    applyMafatihTodaySettings(saved); renderMafatihToday(); renderHomePrayerTimes();
}
