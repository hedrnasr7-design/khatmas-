...
function renderDateBar() {
    ...
    const scheduleText = scheduled ? `الختمة ${scheduled.row.info.number ? toArabicNum(scheduled.row.info.number) + ' ' : ''}${scheduled.row.info.title}${scheduleDay} ${scheduled.matchLabel}` : '';
