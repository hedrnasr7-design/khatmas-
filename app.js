...
window.todayKhatmasSettings = { text: '', bg: '#fffdf0', textColor: '#1b4332', border: '#1b4332', size: 18, speed: 20, slowSpeed: 80 };
function applyTodayKhatmasSettings(settings) {
    ...
    if (track) {
        ...
        const slowSpeed = Math.max(24, Math.min(240, Number(s.slowSpeed) || 80));
        track.style.animationDuration = `${Math.max(24, Math.min(240, slowSpeed - (speed * 0.35)))}s`;
    ...
    const slowSpeed = document.getElementById('todayKhatmasSlowSpeed'); if (slowSpeed) slowSpeed.value = s.slowSpeed;
    renderTodayKhatmas();
}
window.saveTodayKhatmasSettings = async () => { const settings = { text: document.getElementById('todayKhatmasTextInput')?.value.trim() || '', bg: document.getElementById('todayKhatmasBgColor')?.value || '#fffdf0', textColor: document.getElementById('todayKhatmasTextColor')?.value || '#1b4332', border: document.getElementById('todayKhatmasBorderColor')?.value || '#1b4332', size: Number(document.getElementById('todayKhatmasSize')?.value) || 18, speed: Number(document.getElementById('todayKhatmasSpeed')?.value) || 20, slowSpeed: Number(document.getElementById('todayKhatmasSlowSpeed')?.value) || 80 };
