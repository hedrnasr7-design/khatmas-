...
function startAppAfterAccess() {
    ...
    if ('serviceWorker' in navigator) navigator.serviceWorker.register(`./sw-v60.js?v=60`, { updateViaCache: 'none' }).catch(() => {});
}
...
window.addEventListener('pageshow', () => {
    ...
    setTimeout(() => { if (typeof filterKhatmas === 'function') filterKhatmas(); }, 250);
});
