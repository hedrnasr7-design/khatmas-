        ...
        window.uploadAudioToGitHub = async () => {
            ...
            try {
                ...
                for (const oldPath of oldPaths) {
                    ...
                    if (!oldFileResponse.ok) throw new Error(`GitHub ${oldFileResponse.status}: تعذر قراءة المقطع القديم`);
                    ...
                    if (!deleteResponse.ok && deleteResponse.status !== 404) throw new Error(`GitHub ${deleteResponse.status}: تعذر حذف المقطع القديم`);
                }
