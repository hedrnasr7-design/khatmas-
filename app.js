...
function startAppAfterAccess() {
    ...
    if ('serviceWorker' in navigator) navigator.serviceWorker.register(`./sw-v65.js?v=65`, { updateViaCache: 'none' }).catch(() => {});
}
...
async function renderHomePrayerTimes() {
    ...
    navigator.geolocation.getCurrentPosition(async position => {
        try {
            ...
            status.textContent = 'تعذر تحميل المواقيت حاليًا؛ تحقق من الاتصال.';
            list.innerHTML = '';
        }
    }, error => {
